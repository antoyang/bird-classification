...
ipynb) were run on Google Colab. Additionally, notebooks for other homeworks of the Object Recognition and Computer Vision class (Instance_Level_Recognition.ipynb and Neural_Networks.ipynb) are provided.
